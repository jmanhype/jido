defmodule Jido.Agent.PriorityTaskAgent.SendEmail do
  @moduledoc """
  Demo action: Pretends to send an email and updates the agent's result.
  """
  ...
  def run(params, context) do
    ...
    merged_result = Map.merge(result, %{email_sent: params})
  ...
  @doc """
  Returns metadata for the SendEmail action.
  """
